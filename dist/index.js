...
var EventLayer = /*#__PURE__*/function (_Layer) {
  ...
  _createClass(EventLayer, [{
    ...
    value: function handleRectStart(e) {
      ...
      var global = this.startPoint.global; // this.setTip({ text: '移动开始绘制', position: global });
    ...
    value: function onMouseClick(e) {
      // 对外暴露事件执行
      this.map.eventsObServer.emit(EEventType.Click, this.getMouseEventPoint(e)); // 对单击增加选中功能
